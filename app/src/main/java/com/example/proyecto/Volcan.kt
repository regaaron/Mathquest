...
class Volcan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.volcan)
    ...
    fun Jugar(){
        ...
        if (lienzo.isMoving) {
            ...
            when (jugar) {
                1 -> startMultiplicationActivity(1)
                2 -> startMultiplicationActivity(2)
                3 -> startMultiplicationActivity(3)
                4 -> startMultiplicationActivity(4)
                5 -> startMultiplicationActivity(5)
            }
        }
    }

    fun startMultiplicationActivity(nivel: Int) {
